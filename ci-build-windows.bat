...
set CC=clcache
set CXX=clcache
call cmake -G Ninja -DCMAKE_BUILD_TYPE=Release -DL0_ROOT=%cd%/../third_party/level_zero_windows -DBOOST_ROOT=C:\boost -DBoost_COMPILER="-vc" -DBOOST_LIB_TOOLSET="vc" -DZLIB_ROOT=C:\zlib -DPNG_ROOT=C:\libpng -DOPENCL_ROOT=C:\opencl .. || exit /b

...
class XePingPong{
  public:
    ...
    /* Helper Functions */
    void create_module(L0Context &context, std::vector<uint8_t> binary_file, ze_module_format_t format, const char* build_flag);
    void set_argument_value(L0Context &context, uint32_t argIndex,
